...
-- key_NUMPAD0 = Key vK_NUMPAD0 ["np0"] Nothing False False
-- key_NUMPAD0_2 = Key vK_NUMPAD0 ["numpad0"] Nothing False False
-- key_NUMPAD1 = Key vK_NUMPAD1 ["np1"] Nothing False False
-- key_NUMPAD1_2 = Key vK_NUMPAD1 ["numpad1"] Nothing False False
-- key_NUMPAD2 = Key vK_NUMPAD2 ["np2"] Nothing False False
-- key_NUMPAD2_2 = Key vK_NUMPAD2 ["numpad2"] Nothing False False
-- key_NUMPAD3 = Key vK_NUMPAD3 ["np3"] Nothing False False
-- key_NUMPAD3_2 = Key vK_NUMPAD3 ["numpad3"] Nothing False False
-- key_NUMPAD4 = Key vK_NUMPAD4 ["np4"] Nothing False False
-- key_NUMPAD4_2 = Key vK_NUMPAD4 ["numpad4"] Nothing False False
-- key_NUMPAD5 = Key vK_NUMPAD5 ["np5"] Nothing False False
-- key_NUMPAD5_2 = Key vK_NUMPAD5 ["numpad5"] Nothing False False
-- key_NUMPAD6 = Key vK_NUMPAD6 ["np6"] Nothing False False
-- key_NUMPAD6_2 = Key vK_NUMPAD6 ["numpad6"] Nothing False False
-- key_NUMPAD7 = Key vK_NUMPAD7 ["np7"] Nothing False False
-- key_NUMPAD7_2 = Key vK_NUMPAD7 ["numpad7"] Nothing False False
-- key_NUMPAD8 = Key vK_NUMPAD8 ["np8"] Nothing False False
-- key_NUMPAD8_2 = Key vK_NUMPAD8 ["numpad8"] Nothing False False
-- key_NUMPAD9 = Key vK_NUMPAD9 ["np9"] Nothing False False
-- key_NUMPAD9_2 = Key vK_NUMPAD9 ["numpad9"] Nothing False False
...
-- key_BANG = Key vK_1 ["bang"] (Just '!') True False
-- key_EXPCLAMATION = Key vK_1 ["exclamation"] (Just '!') True False
-- key_AT = Key vK_2 ["at"] (Just '@') True False
-- key_HASH = Key vK_3 ["hash"] (Just '#') True False
-- key_DOLLAR = Key vK_4 ["dollar"] (Just '$') True False
-- key_PERCENT = Key vK_5 ["percent"] (Just '%') True False
-- key_CARET = Key vK_6 ["caret"] (Just '^') True False
-- key_AND = Key vK_7 ["and"] (Just '&') True False
-- key_AMPERSAND = Key vK_7 ["ampersand"] (Just '&') True False
-- key_STAR = Key vK_8 ["star"] (Just '*') True False
-- key_ASTERISK = Key vK_8 ["asterisk"] (Just '*') True False
-- key_LEFT_PAREN = Key vK_9 ["leftparen"] (Just '(') True False
-- key_L_PAREN = Key vK_9 ["lparen"] (Just '(') True False
-- key_RIGHT_PAREN = Key vK_0 ["rightparen"] (Just ')') True False
-- key_R_PAREN = Key vK_0 ["rparen"] (Just ')') True False
