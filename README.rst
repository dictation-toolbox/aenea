...
7) On the Linux host, install python-jsonrpclib and xdotool. If necessary, adjust the networking settings in aenea/config.py (server) and aenea/util/config.py (client).
